...
class ChangePassPinCodeVerificationScreen extends StatefulWidget {
  final String personalNumber;
  ChangePassPinCodeVerificationScreen(this.personalNumber);

  @override
  _ChangePassPinCodeVerificationScreenState createState() =>
      _ChangePassPinCodeVerificationScreenState();
}

class _ChangePassPinCodeVerificationScreenState
    extends State<ChangePassPinCodeVerificationScreen> {
  var onTapRecognizer;
